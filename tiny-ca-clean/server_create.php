...
$config = array('config' => './openssl.cnf', "digest_alg" => "sha256", "x509_extensions" => "server_cert");

$dn = array(
		"countryName" => "SE",
		"stateOrProvinceName" => "Stockholm",
		"localityName" => "Stockholm",
		"organizationName" => "tinyca",
		"organizationalUnitName" => "tinyca",
		"commonName" => $cn,
		"emailAddress" => $cn."@tinyca.se",
);
